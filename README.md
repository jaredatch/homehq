...
The project guide (for contributors and AI agents) is [CLAUDE.md](./CLAUDE.md). The implementation roadmap is [PLAN.md](./PLAN.md). Local setup and troubleshooting live in [BOOTSTRAP.md](./BOOTSTRAP.md). Production setup lives in [docs/deployment.md](./docs/deployment.md), and the Google Cloud walkthrough in [docs/google-oauth-setup.md](./docs/google-oauth-setup.md). The original product spec is archived at [docs/archive/SPEC.md](./docs/archive/SPEC.md).
